...
from fastapi import APIRouter, UploadFile, File
from fastapi.responses import FileResponse
from app.services.video_service import create_templated_video  # Correct import
...
async def generate_video(
    ...
    try:
        # Save the uploaded video file in a temporary folder
        with tempfile.NamedTemporaryFile(delete=False, suffix=".mp4") as temp_file:
            temp_file_path = temp_file.name
            with open(temp_file_path, "wb") as f:
                f.write(await video_file.read())
        
        # Set path for the generated video
        output_video_path = "static/generated_videos/generated_output_video.mp4"
        
        # Generate the video using the create_templated_video function
        create_templated_video(temp_file_path, text_string, output_video_path, "template.png", video_pos=(85, 250))
        
        # Delete the temporary video file
        os.remove(temp_file_path)
        
        # Make sure the video is successfully created before returning the response
