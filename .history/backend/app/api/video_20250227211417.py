...
class VideoRequest(BaseModel):
    text_string: str
    video_pos: tuple = (100, 1150)
    template_path: str = "template.png"  # Path to the template (you can make this dynamic)
    output_filename: str = "output_video.mp4"


@app.post("/generate_video/")
async def create_templated_video(request: VideoRequest, video_file: UploadFile = File(...), template_file: UploadFile = File(...)):
    try:
        ...
        create_video(temp_video_path, request.text_string, output_path, temp_template_path, video_pos=request.video_pos)
...
def create_video(input_video_path, text_string, output_path, template_path, video_pos=(100, 1150)):
    try:
        ...
        while cap.isOpened():
            ...
            # Add text
            cv2.putText(result, text_string, (100, 1150), 
...
if __name__ == "__main__":
    ...
    create_video(input_video, text_to_add, output_video, template_image, video_pos=(85, 250))
