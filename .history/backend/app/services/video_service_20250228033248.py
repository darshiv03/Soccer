...
def create_templated_video(input_video_path, text_string, output_path, template_path, video_pos=(100, 1150)):
    try:
        ...
        while True:
            ...
            # Resize frame for overlay and prepare result frame
        ...
        # Re-encode the temporary video with FFmpeg to repackage it (ensuring moov atom is at the front)
        ...
        ffmpeg_cmd = [
            ...
            "-crf", "22",            # Constant rate factor (adjust for quality)
