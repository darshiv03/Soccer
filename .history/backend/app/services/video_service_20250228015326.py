...
def create_templated_video(input_video_path, text_string, output_path, template_path, video_pos, text_pos=(100, 1150)):
    try:
        ...
        print("Template image loaded successfully.")  # Debugging log
        ...
        print("Input video opened successfully.")  # Debugging log
        ...
        print(f"Video writer initialized. Saving to {output_path}")  # Debugging log
        ...
        print(f"Video saved at: {output_path}")  # Debugging log
