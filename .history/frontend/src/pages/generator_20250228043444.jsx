  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.data.error) {
        ...
        // With FileResponse, the file is streamed. If you prefer a JSON with the video URL,
        // you can modify the backend to return {"video_url": "<url>"}.
        // For this example, we assume the file is saved and served via the static route.
        // You may need to adjust your static file mounting accordingly.
        // For now, we'll generate the URL from the unique filename.
        const videoUrl = `http://127.0.0.1:8000/static/generated_videos/${response.data.split("/")[
          ...
          <div className="p-6">
            ...
            {loading && (
              <div className="mt-4 text-center">
                <p>Loading video...</p>
                {/* Replace with a spinner/animation as desired */}
              </div>
            )}
          </div>
        </Card>
